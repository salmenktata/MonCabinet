...
const LEGAL_SYNONYMS: Record<string, string[]> = {
  ...
  'action publique': ['الدعوى العمومية', 'التتبع الجزائي', 'الدعوى الجزائية', 'مجلة الإجراءات الجزائية'],
  'prescription pénale': ['التقادم الجزائي', 'تقادم الدعوى العمومية', 'الفصل 5 م.إ.ج', 'مجلة الإجراءات الجزائية'],
  ...
  'indemnité de licenciement': ['تعويض الطرد', 'تعويض انهاء عقد الشغل', 'الفصل 23 مجلة الشغل', 'تعويض الأقدمية'],
