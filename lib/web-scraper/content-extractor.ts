...
// Re-exports depuis text-utils.ts (rétrocompatibilité — tous les imports existants continuent de fonctionner)
export { hashContent, hashUrl, countWords, normalizeText, detectTextLanguage } from './text-utils'
